...
namespace FairyGUI
{
    ...
    public class UIPackage
    {
        ...
        private static string ChekPath(string assetPath)
        {
            if(!assetPath.StartsWith("Assets/") && !assetPath.StartsWith("FGui/")) assetPath = "FGui/" + assetPath;
            return assetPath;
        }
